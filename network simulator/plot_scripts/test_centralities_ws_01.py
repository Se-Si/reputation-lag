...
prepped_results_flat = prep_results_for_plot(
    "2021-10-04", "03-32-28", True, results_idcs
)
# "2021-09-20", "23-54-44"
prepped_results_dc = prep_results_for_plot(
    "2021-10-04", "03-45-14", True, results_idcs
)
# "2021-09-23", "11-16-43"
prepped_results_spbc = prep_results_for_plot(
    "2021-10-04", "04-05-24", True, results_idcs
)
# "2021-09-23", "17-50-38"
prepped_results_cc = prep_results_for_plot(
    "2021-10-04", "04-46-36", True, results_idcs
)
prepped_results_ec = prep_results_for_plot(
    "2021-10-04", "04-50-54", True, results_idcs
)
