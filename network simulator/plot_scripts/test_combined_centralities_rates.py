"""
This script generates Figures 10 and 11 from the paper.
"""
...
prepped_results_dc = prep_results_for_plot(
    "2021-10-08", "21-35-21", True, results_idcs
)
# "2021-09-23", "11-16-43"
# "2021-10-05", "15-18-59"
prepped_results_spbc = prep_results_for_plot("2021-10-08", "21-47-41 ", True)
# "2021-09-23", "17-50-38"
# "2021-10-05", "15-19-14"
prepped_results_cc = prep_results_for_plot(
    "2021-10-08", "22-03-39", True, results_idcs
)
# 21-11-13
# "2021-10-08", "21-15-48"
prepped_results_ec = prep_results_for_plot(
    "2021-10-08", "22-11-27", True, results_idcs
)
...
plotter_object.plot_results(**plot_dict, axhline=axhline)
# TODO
